termux_step_massage() {
	...
	# to-do remove we never operate under glibc folder  it is always empty  . it is just an empty shell that should never have existed because dpkg --root solve this problem 
	local ADDING_PREFIX=""
