...
TERMUX_PKG_GIT_BRANCH="android-8.0.0_r51"
...
# cd $TERMUX_PKG_SRCDIR
	for i in $(seq 0 $(( ${#TERMUX_PKG_SRCURL2[@]}-1 ))); do
		git clone --depth 1 --single-branch 	--branch $TERMUX_PKG_GIT_BRANCH		${TERMUX_PKG_SRCURL2[$i]}
	done
}
...
termux_step_pre_configure() {
	...
	CPPFLAGS+=" -D__USE_GNU -I$TERMUX_PKG_CACHEDIR/core/libcutils/include"
	TERMUX_PKG_EXTRA_CONFIGURE_ARGS+=" -Dc_cpp_args=-I$TERMUX_PKG_CACHEDIR/core/libcutils/include
	--includedir=$TERMUX_PKG_CACHEDIR/core/libcutils/include:$TERMUX_PKG_CACHEDIR/native/libs/nativewindow/include"
	LDFLAGS+=" -landroid-spawn -landroid-shmem"
	# LDFLAGS+=" -llog -lcutils -lsync -lhardware  -landroid-spawn -landroid-shmem"
	export PKG_CONFIG_PATH=../src
	export C_INCLUDE_PATH=$TERMUX_PKG_CACHEDIR/core/liblog/include:$TERMUX_PKG_CACHEDIR/core/libcutils/include:$TERMUX_PKG_CACHEDIR/core/libsystem/include:$TERMUX_PKG_SRCDIR/include/android_stub
